          ...
          <div className="flex items-center gap-1.5" suppressHydrationWarning>
            {units.map(({ label, value }, i) => (
              <div key={label} className="flex items-center gap-1.5">
                <div className="bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-center min-w-[64px] backdrop-blur-sm shadow-[0_4px_12px_rgba(0,0,0,0.3)]">
